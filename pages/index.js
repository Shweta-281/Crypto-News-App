    ...
    <div className="flex flex-col relative bg-background font-raleway items-center min-h-screen">
      ...
      <div className="mt-12 sm:mx-auto justify-center sm:w-full sm:flex">
        <div className="mt-4 sm:mt-0 sm:ml-3">
          {!response && (
            <button
              className="block w-full rounded-md px-5 py-3 bg-primary text-base font-bold text-background focus:outline-none focus:ring-2 focus:ring-primary sm:px-10"
              onClick={() => getNews()}
            >
              Get Latest News
            </button>
          ...
          response.map((news) => {
            return (
              ...
              <div className="mt-10 grid justify-items-center">
                ...
                ></img>
                <a
                  className="text-active text-center hover:text-primary transition-colors duation-200"
                  key={news.news_ID}
